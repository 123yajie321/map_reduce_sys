...
import map_reduce_sys.gestion.createPluginOutboundPort;
...
public class Tmp {
	...
	public synchronized void execute() throws Exception {
		...
		sizeTuple.setIndiceTuple(0, 5000);
		sizeTuple.setIndiceTuple(1, 0);
		
		Tuple sizeTuple2=new Tuple(2);
		sizeTuple2.setIndiceTuple(0, 10000);
		sizeTuple2.setIndiceTuple(1, 5000);
		Tuple sizeTuple3=new Tuple(2);
		sizeTuple3.setIndiceTuple(0, 10000);
		...
		*/
		...
		Runnable taskReduce = () -> {
			 try {
				 pluginReduceOut.getServicePort().runTaskReduce(g_reduce, sizeTuple3,Nature.COMMUTATIVE_ASSOCIATIVE);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public synchronized void execute() throws Exception {
		...
		Tuple sizeTuple=new Tuple(2);
		sizeTuple.setIndiceTuple(0, 30000);
		sizeTuple.setIndiceTuple(1, 0);
		/*
		Tuple sizeTuple2=new Tuple(2);
		sizeTuple2.setIndiceTuple(0, 10000);
...
/*
	...
	*/	
		...
		Runnable taskReduce = () -> {
			 try {
				 pluginReduceOut.getServicePort().runTaskReduce(g_reduce, sizeTuple,Nature.COMMUTATIVE_ASSOCIATIVE);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
